...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Home Alone Anomaly Wiki',
    description: 'Copyright and intellectual property information for Home Alone Anomaly Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Home Alone Anomaly Wiki',
      description: 'Copyright and intellectual property information for Home Alone Anomaly Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Home Alone Anomaly Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Home Alone Anomaly Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Home Alone Anomaly Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Home Alone Anomaly Developers</strong> - Creators of the Home Alone Anomaly game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Home Alone Anomaly</strong> - Trademark of the game developers</li>
              <li><strong>Home Alone Anomaly Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Home Alone Anomaly Wiki.
            </p>
            ...
            <p>
              ...
              Home Alone Anomaly Wiki<br />
              Email: <a href="mailto:dmca@home-alone-anomaly.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@home-alone-anomaly.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Home Alone Anomaly Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Home Alone Anomaly Wiki (home-alone-anomaly.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@home-alone-anomaly.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@home-alone-anomaly.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@home-alone-anomaly.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@home-alone-anomaly.wiki</a>
            </p>
            <p>
