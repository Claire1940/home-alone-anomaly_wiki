...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Home Alone Anomaly Wiki",
    description: "Read the Terms of Service for Home Alone Anomaly Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Home Alone Anomaly Wiki",
      description: "Terms and conditions for using Home Alone Anomaly Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Home Alone Anomaly Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Home Alone Anomaly Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Home Alone Anomaly Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Home Alone Anomaly Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Home Alone Anomaly". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Walkthrough and survival strategies</li>
              <li>Visitor guides and trust analysis</li>
              <li>Anomaly clue catalogs</li>
              <li>Ending and choice guides</li>
              <li>Survival tips and quick advice</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Home Alone Anomaly Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Home Alone Anomaly. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Home Alone Anomaly Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Home Alone Anomaly. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> The Roblox game may receive updates, changes, or removals without notice. We are not responsible for in-game changes or availability.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, HOME ALONE ANOMALY WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Home Alone Anomaly Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@home-alone-anomaly.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@home-alone-anomaly.wiki</a>
            </p>
            <p>
